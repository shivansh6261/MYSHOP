...
export default function LoginPage() {
    ...
    return (
        // Outer Container: Full height, full width, centered content, simple white background
        <div className="min-h-screen w-full flex items-center justify-center bg-white px-4 sm:px-6 lg:px-8">
            
            {/* Inner Container: 100% width up to a readable max-width, NO card styling */}
            <div className="w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Social Login Button (Google Mock) */}
                    <button
                        type="button"
                        className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 font-bold py-3 px-4 rounded-lg hover:bg-gray-50 transition-all"
                    >
