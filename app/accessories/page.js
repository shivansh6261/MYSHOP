...
export default function AccessoriesCategoryPage() {
  ...
  // MOCK DATA: Accessories Products
  const accessoriesProducts = [
    { id: 1, name: 'Classic Chronograph Watch', price: '₹5,999', category: 'Watches', image: 'https://images.unsplash.com/photo-1524592094714-0f0654e20314?w=500&q=80' },
    { id: 2, name: 'Polarized Aviator Sunglasses', price: '₹2,499', category: 'Eyewear', image: 'https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=500&q=80' },
    { id: 3, name: 'Genuine Leather Belt', price: '₹1,499', category: 'Leather Goods', image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=500&q=80' },
    { id: 4, name: 'Minimalist Gold Pendant', price: '₹3,999', category: 'Jewelry', image: 'https://images.unsplash.com/photo-1599643478524-fb66f70d00ea?w=500&q=80' },
    { id: 5, name: 'Premium Canvas Tote Bag', price: '₹2,199', category: 'Bags', image: 'https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=500&q=80' },
    { id: 6, name: 'Wool Fedora Hat', price: '₹1,899', category: 'Headwear', image: 'https://images.unsplash.com/photo-1514327605112-b887c0e61c0a?w=500&q=80' },
    { id: 7, name: 'Silk Patterned Scarf', price: '₹1,299', category: 'Scarves', image: 'https://images.unsplash.com/photo-1601924994987-69e26d50dc26?w=500&q=80' },
    { id: 8, name: 'Woven Leather Wallet', price: '₹1,599', category: 'Leather Goods', image: 'https://images.unsplash.com/photo-1627123424574-724758594e93?w=500&q=80' },
  ];
