      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-4">
            <Link href="/" className="text-3xl font-black text-white tracking-tighter inline-block mb-2">
              MY<span className="text-emerald-500">SHOP</span>
            </Link>
            <p className="text-gray-400 text-sm leading-relaxed">
              Elevating your everyday wardrobe with premium quality and timeless designs. Crafted for the modern lifestyle.
            </p>
            {/* Social Icons (SVGs) */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/accessories" className="hover:text-emerald-400 transition-colors">Accessories</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/faq" className="hover:text-emerald-400 transition-colors">FAQ & Help Center</Link></li>
              <li><Link href="/track-order" className="hover:text-emerald-400 transition-colors">Track Your Order</Link></li>
              <li><Link href="/returns" className="hover:text-emerald-400 transition-colors">Returns & Exchanges</Link></li>
              <li><Link href="/shipping" className="hover:text-emerald-400 transition-colors">Shipping Information</Link></li>
          ...
          {/* 4. Newsletter Signup */}
          <div>
            <h3 className="text-white font-bold uppercase tracking-wider mb-4">Stay in the Loop</h3>
            ...
            <form className="flex flex-col space-y-2" onSubmit={(e) => e.preventDefault()}>
              <input 
                ...
                className="bg-gray-800 text-white px-4 py-3 rounded-lg border border-gray-700 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all w-full"
                required
              />
              <button 
                type="submit" 
                className="bg-emerald-600 text-white font-bold px-4 py-3 rounded-lg hover:bg-emerald-700 transition-colors w-full"
              >
                Subscribe
              </button>
            </form>
